                ...
                <div className="bg-gradient-to-r from-[rgb(163,230,53)] to-[rgb(77,124,15)] w-[48rem] h-[36rem] rounded-lg flex flex-col">
                    ...
                    <form className="flex flex-col justify-center gap-8 h-full mt-12">
                        <div className="flex gap-12 justify-center">
                            <div>
                                <label htmlFor='name' />
                                <input type="text" placeholder="Full Name" className="h-8 w-56 rounded px-4" />
                            </div>
                            <div>
                                <label for="donar"></label>
                                <select name="donar" id="donar" className="h-8 w-56 rounded px-4" >
                        ...
                        <div className="flex gap-12 justify-center">
                            ...
                            <div>
                                <label htmlFor='area' />
                                <input type="text" placeholder="Dropdown Area" className="h-8 w-56 rounded px-4" />
                            </div>
                        </div>
                        <div className="flex gap-12 justify-center">
                            <div>
                            ...
                            <div>
                                <label htmlFor='type' />
                                <input type="text" placeholder="Type of Food" className="h-8 w-56 rounded px-4" />
                            </div>
                        </div>
                        <div className="flex gap-12 justify-center">
                            <div>
